...
export default function Home() {
  ...
  // Allow unauthenticated users to view the home page
  // useEffect(() => {
  //   if (!authLoading && !user) {
  //     // Add a small delay and check again to prevent redirect loops
  ...
  if (!user) {
    // Allow unauthenticated users to view the home page but show login prompts for actions
  }
    ...
    <MobileLayout>
      ...
      <div className="relative overflow-hidden md:block">
        ...
        {/* Main hero content - compact on mobile */}
            <div className="relative z-10 px-4 py-6 md:py-20 text-center md:max-w-3xl md:mx-auto md:px-8">
