...
const adminNavigation = [
  ...
  { 
    ...
    icon: Trophy,
    description: "Create admin challenges"
  },
  { 
    name: "Disputes", 
  ...
  { 
    ...
    href: "/admin/payouts", 
    icon: DollarSign,
    description: "Manage pending payouts to users"
  },
  { 
    name: "Transactions", 
    href: "/admin/transactions", 
    icon: DollarSign,
    description: "Platform payments and transactions"
  },
  { 
    name: "Users", 
    href: "/admin/users", 
  ...
  { 
    ...
    href: "/admin/bonuses", 
    icon: Gift,
    description: "Configure bonus offers and rewards"
  },
  { 
    name: "Wallet", 
    href: "/admin/wallet", 
