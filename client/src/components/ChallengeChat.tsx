...
export function ChallengeChat({ challenge, onClose }: ChallengeChatProps) {
  ...
  const isAwaitingAcceptance = challenge.status === 'pending' || challenge.status === 'open';
  const isActive = challenge.status === 'active';
  const canAccept = isAwaitingAcceptance && user?.id === challenge.challenged;
      ...
      {isOpenChallenge ? (
          ...
          <div className="text-center py-8">
            ...
            <Button 
              ...
              onClick={() => toast({
                ...
                description: "Challenge joining feature is coming soon!",
              })}
            >
              Join Challenge
            </Button>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {isLoading ? (
            ...
            <>
              {displayMessages.filter(msg => msg && typeof msg === 'object' && msg.id).map((msg: Message) => (
                <div
                  key={msg.id}
